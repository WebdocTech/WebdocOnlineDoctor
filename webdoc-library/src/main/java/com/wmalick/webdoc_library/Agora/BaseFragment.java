...
public abstract class BaseFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View layout = view.findViewById(Window.ID_ANDROID_CONTENT);
    ...
    public boolean checkSelfPermission(String permission, int requestCode) {
        ...
        if (Manifest.permission.RECORD_AUDIO.equals(permission)) {
            ((AGApplication) getActivity().getApplication()).initWorkerThread();
        }
        return true;
    }
    ...
    protected final WorkerThread worker() {
        return (WorkerThread) ((AGApplication) getActivity().getApplication()).getWorkerThread();
    }
    ...
    protected int virtualKeyHeight() {
        boolean hasPermanentMenuKey = ViewConfigurationCompat.hasPermanentMenuKey(ViewConfiguration.get(getActivity().getApplication()));
